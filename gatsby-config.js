...
module.exports = {
  ...
  siteMetadata: {
    ...
    keywords: `доставка воды в симферополе, доставка воды симферополь, купить воду, доставка воды крым, вода симферополь, чистая вода симферополь, купить кулер в симферополе, единая доставка воды`
  },
  plugins: [
    `gatsby-plugin-image`,
    {
