...
module.exports = {
  ...
  siteMetadata: {
    ...
    title: "Питьевая вода в Симферополе и Симферопольском районе",
    ...
    keywords: `доставка воды в Симферополе, заказ воды в Симферополе, бесплатная доставка воды, питьевая вода в Симферополе, доставка питьевой воды, вода в бутылках, вода 19 литров`
  },
  plugins: [
    {
